...
describe('test palindrome (string reversal)', function() {
  it('should reverse string iteratively', () => {
    ...
    expect(reverseStringIterative('njnschnjkdasn j32 uida')).toEqual(
  ...
  it('should reverse string recursively', () => {
    ...
    expect(reverseStringRecursive('njnschnjkdasn j32 uida')).toEqual(
      'adiu 23j nsadkjnhcsnjn'
    )
  ...
  it('should reverse string using built in functions', () => {
    ...
    expect(reverseStringOneLiner('njnschnjkdasn j32 uida')).toEqual(
      'adiu 23j nsadkjnhcsnjn'
    )
