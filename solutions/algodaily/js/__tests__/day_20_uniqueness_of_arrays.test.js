...
describe('uniqueness of arrays tests', () => {
  it('should return an array with the unique elements', () => {
    ...
    expect(uniques([13, 5, 3, 5, 8, 13, 14, 5, 9])).toEqual([
      13,
      5,
      3,
      8,
    ...
    ).toEqual([8, 15, 6, 19, 7, 12, 3, 13, 9, 14, 1, 4, 11, 16])
    ...
    expect(
      uniques([6, 12, 5, 1, 4, 18, 10, 17, 10, 0, 1, 7, 6, 18, 11, 2, 15, 19])
    ).toEqual([6, 12, 5, 1, 4, 18, 10, 17, 0, 7, 11, 2, 15, 19])
    expect(
      uniques([
        9,
        0,
    ...
    expect(
      uniques([5, 10, 3, 17, 9, 12, 19, 4, 16, 19, 7, 9, 7, 8, 10])
    ).toEqual([5, 10, 3, 17, 9, 12, 19, 4, 16, 7, 8])
  })
})
